...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->TON0.,PT,,__time_to_timespec(1, 750, 0, 0, 0, 0));
  ...
  __SET_VAR(data__->TON1.,PT,,__time_to_timespec(1, 750, 0, 0, 0, 0));
  ...
  __SET_VAR(data__->TON2.,PT,,__time_to_timespec(1, 750, 0, 0, 0, 0));
  ...
  if (__GET_VAR(data__->POS_RAISE_BASE,)) {
    __SET_VAR(data__->,MOVE_Z,,__BOOL_LITERAL(FALSE));
  };
  if (__GET_VAR(data__->POS_RAISE_BASE,)) {
    __SET_VAR(data__->,MOVE_X,,__BOOL_LITERAL(FALSE));
  };
  __SET_VAR(data__->F_TRIG3.,CLK,,__GET_VAR(data__->PART_LEAVING,));
  ...
  __SET_VAR(data__->R_TRIG0.,CLK,,(__GET_VAR(data__->POS_AT_LIMIT_LID,) && __GET_VAR(data__->POS_RAISE_BASE,)));
